 ...
 * @file qspi_w25q128.h
 *
 * @brief QSPI flash driver for the Winbond W25Q128
 *
...
#ifndef W25Q_128Mb_SIZE
#define W25Q_128Mb_SIZE   0x18
#endif

#if (FLASH_AUTODETECT == 1) || (dg_configFLASH_MANUFACTURER_ID == WINBOND_ID && \
        dg_configFLASH_DEVICE_TYPE == W25Q128 && dg_configFLASH_DENSITY == W25Q_128Mb_SIZE)

#include "qspi_common.h"

#include "qspi_winbond.h"

static void flash_w25q128_sys_clock_cfg(sys_clk_t sys_clk);
static uint8_t flash_w25q128_get_dummy_bytes(void);

static const qspi_flash_config_t flash_w25q128_config = {
        .manufacturer_id               = WINBOND_ID,
        .device_type                   = W25Q128,
        .device_density                = W25Q_128Mb_SIZE,
        ...
        .sys_clk_cfg                   = flash_w25q128_sys_clock_cfg,
        .get_dummy_bytes               = flash_w25q128_get_dummy_bytes,
        ...
        const qspi_flash_config_t* const flash_config = &flash_w25q128_config;
#endif

__RETAINED_CODE static void flash_w25q128_sys_clock_cfg(sys_clk_t sys_clk)
{

}

__RETAINED_CODE static uint8_t flash_w25q128_get_dummy_bytes(void)
{
        return 2;
}
#endif
