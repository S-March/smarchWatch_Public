 ...
 ****************************************************************************************
 */
__STATIC_INLINE void ke_queue_push(struct co_list *const queue, struct co_list_hdr *const element)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE struct co_list_hdr *ke_queue_pop(struct co_list *const queue)
{
